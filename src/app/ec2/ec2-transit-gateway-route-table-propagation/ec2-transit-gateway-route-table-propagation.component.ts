...
@Component({
  selector: 'app-ec2-transit-gateway-route-table-propagation',
  templateUrl: './ec2-transit-gateway-route-table-propagation.component.html',
  styleUrls: ['./ec2-transit-gateway-route-table-propagation.component.css']
})
export class Ec2TransitGatewayRouteTablePropagationComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
