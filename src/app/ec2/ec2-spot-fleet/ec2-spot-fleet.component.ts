...
@Component({
  selector: 'app-ec2-spot-fleet',
  templateUrl: './ec2-spot-fleet.component.html',
  styleUrls: ['./ec2-spot-fleet.component.css']
})
export class Ec2SpotFleetComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
