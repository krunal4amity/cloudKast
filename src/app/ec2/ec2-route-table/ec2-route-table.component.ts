...
@Component({
  selector: 'app-ec2-route-table',
  templateUrl: './ec2-route-table.component.html',
  styleUrls: ['./ec2-route-table.component.css']
})
export class Ec2RouteTableComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
