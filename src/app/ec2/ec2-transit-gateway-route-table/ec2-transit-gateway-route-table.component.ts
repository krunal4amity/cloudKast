...
@Component({
  selector: 'app-ec2-transit-gateway-route-table',
  templateUrl: './ec2-transit-gateway-route-table.component.html',
  styleUrls: ['./ec2-transit-gateway-route-table.component.css']
})
export class Ec2TransitGatewayRouteTableComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
