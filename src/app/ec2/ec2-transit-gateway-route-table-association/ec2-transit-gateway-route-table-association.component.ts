...
@Component({
  selector: 'app-ec2-transit-gateway-route-table-association',
  templateUrl: './ec2-transit-gateway-route-table-association.component.html',
  styleUrls: ['./ec2-transit-gateway-route-table-association.component.css']
})
export class Ec2TransitGatewayRouteTableAssociationComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
