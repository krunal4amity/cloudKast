...
@Component({
  selector: 'app-ec2-subnet-route-table-association',
  templateUrl: './ec2-subnet-route-table-association.component.html',
  styleUrls: ['./ec2-subnet-route-table-association.component.css']
})
export class Ec2SubnetRouteTableAssociationComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
