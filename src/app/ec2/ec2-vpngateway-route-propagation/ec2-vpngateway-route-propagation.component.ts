...
@Component({
  selector: 'app-ec2-vpngateway-route-propagation',
  templateUrl: './ec2-vpngateway-route-propagation.component.html',
  styleUrls: ['./ec2-vpngateway-route-propagation.component.css']
})
export class Ec2VPNGatewayRoutePropagationComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
