...
@Component({
  selector: 'app-ec2-network-acl',
  templateUrl: './ec2-network-acl.component.html',
  styleUrls: ['./ec2-network-acl.component.css']
})
export class Ec2NetworkAclComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
