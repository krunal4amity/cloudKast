...
@Component({
  selector: 'app-ec2-launch-template',
  templateUrl: './ec2-launch-template.component.html',
  styleUrls: ['./ec2-launch-template.component.css']
})
export class Ec2LaunchTemplateComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
