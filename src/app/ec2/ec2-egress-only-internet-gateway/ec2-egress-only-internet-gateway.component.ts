...
@Component({
  selector: 'app-ec2-egress-only-internet-gateway',
  templateUrl: './ec2-egress-only-internet-gateway.component.html',
  styleUrls: ['./ec2-egress-only-internet-gateway.component.css']
})
export class Ec2EgressOnlyInternetGatewayComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
