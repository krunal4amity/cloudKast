...
@Component({
  selector: 'app-ec2-vpnconnection-route',
  templateUrl: './ec2-vpnconnection-route.component.html',
  styleUrls: ['./ec2-vpnconnection-route.component.css']
})
export class Ec2VPNConnectionRouteComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
