...
@Component({
  selector: 'app-ec2-transit-gateway-route',
  templateUrl: './ec2-transit-gateway-route.component.html',
  styleUrls: ['./ec2-transit-gateway-route.component.css']
})
export class Ec2TransitGatewayRouteComponent implements OnInit {
  tagCount:number;
  tagArray;
  isPresent:boolean;
