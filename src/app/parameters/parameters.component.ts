...
export class ParametersComponent implements OnInit {
  ...
  isPresent=true;
  isCopyReady=false;
  regexTooltip="Do not add an additional backlash to any backlash characters in your regular expression. Escape characters will be automatically added. E.g. if you need to include a \\d in your regular expression, leave it as \\d."
